    ...
    def __init__(self):
        ...
        try:
            while rclpy.ok():
                ...
                joint_state.name = [
                    'lf_caster_rotation_joint', 'lf_caster_wheel_joint',
                    'rf_caster_rotation_joint', 'rf_caster_wheel_joint',
                    'r_caster_rotation_joint', 'r_caster_wheel_joint'
                ]
